  ...
  return (
    <main>
      <Container maxWidth="lg" sx={ styles.mainContainer } >
        <Grid container>
          <Grid item xs={ 12 } sm={ 6 } sx={ { paddingBottom: '1.75rem' } } >
            <Subtitle
              title="¡Ups! Parece que se mudaron"
              padding="1rem 0rem"
              fontWeight="700"
            />
            <Typography sx={ { paddingBottom: '1.5rem', fontSize: '20px' } } >
              La página que estás buscando no se encuentra disponible.
            </Typography>
            <Typography sx={ { paddingBottom: '0.25rem', fontWeight: '800' } } >
              Código de error: 404
            </Typography>
            <Typography sx={ { padding: '0rem 0rem 1.5rem 0rem', maxWidth: '380px' } }>
          ...
          <Grid item xs={ 12 } sm={ 6 } sx={ { padding: '1rem' } } >
            <img src='https://i.postimg.cc/7YMyptNy/not-found.png' alt="cajas de mudanza" width="100%" />
          </Grid>
        </Grid>
      </Container>
    </main>
